export function renderHomeTab() {
  ...
  section.innerHTML = `
    <div class="relative mx-auto w-full overflow-hidden rounded-3xl border border-slate-800 min-h-[80vh] p-4 sm:p-8">
      ...
      <div id="home-bg-3" class="absolute inset-0 bg-cover bg-center transition-[opacity] duration-500" style="opacity:0; background-image:url('${UDYR_BASE}Udyr_6.jpg')"></div>
